...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Cargar todos los Pokémon inicialmente
    for (let i = 1; i <= 151; i++) {
        loadPokemon(i);
    }
                ...
                <ul class="stats-list">
                 ...
                 <div class="evolutions">
                    ...
                    <ul class="evolution-list">
                        <!-- Aquí se agregarán las evoluciones -->
                    </ul>
                </div>
            </div>
        `;
    ...
    genderFilter.addEventListener("change", () => {
        ...
        pokemonList.innerHTML = ""; // Limpiar la lista antes de cargar
        // Este ejemplo de género no es exacto para todos los Pokémon,
        // ya que la API no proporciona el género exacto por Pokémon
        for (let i = 1; i <= 151; i++) {
            loadPokemon(i);
        }
    });
